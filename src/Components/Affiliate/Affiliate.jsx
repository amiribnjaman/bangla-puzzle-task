    ...
    return (
        ...
        <div className='w-[90%] mx-auto my-12'>
            <div className='md:w-[65%] md:ml-4'>
                {/* Heading */}
                <div>
                    <h1 className=' text-[52px] font-bold mb-1 leading-tight'>Search Your Invitation</h1>
                    <div className='mt-7'>
                        <form>
                            ...
                            <div class="relative">
                                ...
                                <button type="submit" class="text-white w-22 md:w-52 h-12 absolute right-2.5 bottom-2.5 bg-red-600 hover:bg-red-600 focus:ring-0 focus:outline-none font-medium rounded-md text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Join Free</button>
                            </div>
                        </form>
                    </div>
                </div>
