    ...
    return (
        <div>
            <nav class="py-5 bg-white shadow-md border-gray-200 dark:bg-gray-900">
                <div class="w-[90%] flex md:flex-col lg:flex-row flex-wrap items-center justify-between max-w-screen-xl mx-auto p-0 md:p-4">
                    ...
                    <div id="mega-menu-full-cta" className={showMenu === true ? 'items-center justify-between md:flex md:w-auto md:order-1 w-full' : 'hidden'}>
                        <ul class="flex flex-col md:mt-4 lg:mt-0 mt-4 font-medium md:flex-row md:space-x-2 lg:space-x-4">
                            <li className='px-1 lg:px-1 py-2 md:px-0.5'>
                            ...
                            <li className='px-1 py-2 md:px-0.5 lg:px-1'>
                            ...
                            <li className='px-1 py-2 md:px-0.5'>
                            ...
                            <li className='md:px-0.5 bg-red-600 border-0 rounded hover:bg-red-700 hover:border-white px-3 lg:px-3 pt-1.5 pb-2 '>
