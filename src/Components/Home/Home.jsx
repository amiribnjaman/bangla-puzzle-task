      ...
      <div className='md:w-[65%] md:ml-4'>
        ...
        <form>
          ...
          <div class="relative">
            ...
            <input type="email" id="email" class="block w-full leading-9 p-4 text-md pl-16 text-sm text-gray-900 border-1 border-gray-200 shadow-md rounded-lg bg-gray-50 focus:ring-0 focus:border-none focus:shadow-lg dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your Email address" required />
